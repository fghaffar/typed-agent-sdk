...
- [x] T014 [P] [US1] Create `tests/test_hooks.py` — 19 tests covering: matcher regex/none, hook priority ordering, blocking, arg modification, timeout skip, fire-and-forget, error propagation, bad return type, metrics tracking
